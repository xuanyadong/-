...
<form class="layui-form" action="javascript:;" id="frm" method="post">
	...
	<script type="text/html" id="tpl">
			...
			<tr>
				...
				<td><a  onclick="editUser({{item.userId}})"  class="layui-btn layui-btn-mini" "><i class="layui-icon">&#xe642;</i> </a>
					...
					<a  onclick="myTask({{item.userId}})" class="layui-btn layui-btn-mini" "><i class="layui-icon">&#xe63c;</i></a>
				</td>
			</tr>
			{{# }); }}
</script>
	...
	<script type="text/javascript">
		...
		function myTask(userId){
	  			...
	  			maxmin:true,
	  			shade:0.6,
	  			content: ['${basePath}user/getUserTask.do?userId='+userId],//这里content是一个URL，如果你不想让iframe出现滚动条，你还可以content: ['http://sentsin.com', 'no']
		  		end:function(){
		  				location.reload();
		  		}
				});
