...
public class CustomerController {
	...
	private CustomerService customerService;
	  ...
	  @RequestMapping("/getcustomerStatusReport.do")
		public String getDeptUserReport(){
			return "customerStatusReport";
		}
	  @RequestMapping("/listCustomerStatus.do")
	  @ResponseBody
	  public List<Map<String,Integer>> listCustomerStatus(){
		  List<Map<String,Integer>> customerStatus=customerService.listCustomerStatus();
