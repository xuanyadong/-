		...
		<nav class="navbar navbar-default navbar-static-top m-b-0">
			<div class="navbar-header">
				...
				<ul class="nav navbar-top-links navbar-right pull-right">
					...
					<!-- /.dropdown -->
					<li class="dropdown">
					<a class="dropdown-toggle waves-effect waves-light"
				...
				<ul class="nav" id="side-menu">
					...
					<li><a href="index.html" class="waves-effect active"><i
							...
							class="hide-menu"> 客户管理 <span class="fa arrow"></span> <span
								class="label label-rouded label-custom pull-right">2</span></span></a>
						<ul class="nav nav-second-level">
							<li><a href="<%=path%>/user/toUserCustomer.do?userId=${user.userId }" target="adminFrame">我的客户</a></li>
							<%-- <li><a href="<%=path%>/user/getReport.do">生成报表</a></li> --%>
						</ul></li>
					<li><a href="inbox.html" class="waves-effect"><i
						...
						<ul class="nav nav-second-level">
							<li><a href="javascript:void(0)" target="adminFrame">你没有此权限</a></li>
						</ul></li>
						...
						<ul class="nav nav-second-level">
							<li><a href="javascript:void(0)" target="adminFrame">查看部门(权限不够)</a></li>
					...
					<li><a href="forms.html" class="waves-effect"><i
						...
						<ul class="nav nav-second-level">
							<li><a href="<%=path%>/pageOffice/leave.do" target="adminFrame">在线请假</a></li>
